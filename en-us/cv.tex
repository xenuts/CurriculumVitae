...
\begin{longtable}{@{\extracolsep{\fill}} l | l l }
 ...
 % {A question-set limited dialog system implemented by keyword spotting approach with improved online garbage model. My main task is proposing a improved method based on online garbage keyword spotting model.}
